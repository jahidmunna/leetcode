...
class Solution:
    def findOrder(self, numCourses: int, prerequisites: List[List[int]]) -> List[int]:
        ...
        zero_degree = deque(i for i in range(numCourses) if i not in degree)
        # print("Graph: ", graph)
        # print("Degree: ", degree)
        # print("Zero Degree: ", zero_degree)
        ...
        while zero_degree:
            ...
            if neighbors:
                for neighbor in neighbors:
                    ...
                    # print("degree neighbor: ",degree[neighbor])
                    degree[neighbor] -= 1
